...
var detect = function (_a) {
    ...
    if (biggestContour) {
        if (showContours)
            cv.drawContours(frame, biggestContour, -1, [0, r, g, b], 1);
        ...
        if (rectanglePoints.length === 4) {
            ...
            (0, Utilities_1.wrapImage)(frame, resultFrame, rectanglePoints, width, height);
            copiedToResultFrame = true;
        }
    }
    if (resultElement != undefined && copiedToResultFrame)
        cv.imshow(resultElement, resultFrame);
    if (resultElement != undefined && !copiedToResultFrame)
...
var detectVideo = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        var width, height, r, g, b, videoStream, e_1, capture, frame, resultFrame, imageGray, imageBlur, imageThreshold, imageDilated, imageCountours, imageHierarchy, timeout, biggestContour, stoped;
