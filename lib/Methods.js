...
var detect = function (_a) {
    var detectElement = _a.detectElement,
        _b = _a.showContours,
        showContours = _b === void 0 ? false : _b,
        _c = _a.drawRectangle,
        drawRectangle = _c === void 0 ? false : _c,
        scanElement = _a.scanElement,
        resultElement = _a.resultElement,
        img = _a.img,
        contourColor = _a.contourColor;
    if (!img) img = { height: 640, width: 480 };
    var width = img.width,
        height = img.height;
    if (!contourColor) contourColor = { r: 255, g: 255, b: 255 };
    var r = contourColor.r,
        g = contourColor.g,
        b = contourColor.b;
    ...
    if (biggestContour) {
        ...
        if (rectanglePoints.length === 4) {
            if (drawRectangle) (0, Utilities_1.drawRectangle)(frame, rectanglePoints, thickness);
        }
    }
...
var detectVideo = function (_a) {
    var videoDisplayElement = _a.videoDisplayElement,
        _b = _a.showContours,
        showContours = _b === void 0 ? false : _b,
        _c = _a.drawRectangle,
        drawRectangle = _c === void 0 ? false : _c,
        resultElement = _a.resultElement,
        onDetect = _a.onDetect,
        _d = _a.fps,
        fps = _d === void 0 ? 30 : _d,
        img = _a.img,
        contourColor = _a.contourColor;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        var width, height, r, g, b, videoStream, e_1, capture, frame, frameCpy, imageGray, imageBlur, imageThreshold, imageDilated, imageCountours, imageHierarchy, timeout, biggestContour, stoped;
